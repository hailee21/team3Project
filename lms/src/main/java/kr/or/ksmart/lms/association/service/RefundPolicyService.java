...
import kr.or.ksmart.lms.association.mapper.RefundPolicyMapper;
...
public class RefundPolicyService {
	...
	public Map<String, Object> getRefundPolicyList(){
		...
		List<RefundPolicy> refundPolicyAnnualFeeList = refundPolicyMapper.selectRefundPolicyAnnualFeeList();//연회비
		List<RefundPolicy> refundPolicyLectureList = refundPolicyMapper.selectRefundPolicyLectureList();//강의
		List<RefundPolicy> refundPolicyLicenseList = refundPolicyMapper.selectRefundPolicyLicenseList();//자격시험
	...
	public void addRefundPolicy(RefundPolicy refundPolicy){
		...
		String refundPolicyPK = refundPolicyMapper.selectRefundPolicyPk(); //refund_policy 테이블에서 마지막으로 입력된 PK 갑을 가져온다.
