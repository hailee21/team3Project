...
public class AvailableInstitution {
	...
	public String toString() {
		return "AvailableInstitution [availableInstitutionAvailability=" + availableInstitutionAvailability
				+ ", availableInstitutionRemainingDate=" + availableInstitutionRemainingDate + ", institutionCode="
				+ institutionCode + ", institutionName=" + institutionName + ", paymentAnnualFeeCode="
				+ paymentAnnualFeeCode + ", paymentAnnualFeeServiceEndDate=" + paymentAnnualFeeServiceEndDate
